...
const cart =({ name, route, time, seat, price, photo })=>{
...
return (
    ...
    <div
          className="mt-2 p-2 w-11/12 h-[178px] tropCart overflow-y-auto flex flex-wrap searchCartRes"
        >
          {/* <!-- catagory items --> */}
          <div className="w-2/3 flex flex-col flex-wrap justify-between">
            <p className="font-serif  text-xl px-1 ">
              {name}, <sub className="font-bold text-sm">AC</sub>
            </p>
            ...
            <div className="bg-slate-100 rounded-md p-1 flex space-x-1">
              ...
              <p className="text-sm font-serif">| seats: {seat.replace(/Seats/g, " ")}    </p>
            </div>
          </div>
          {/* <!-- photo --> */}
          <div className="w-1/3 flex items-center justify-center">
            <div className="">
              <img src={photo === "sohoj" ? sohoj : jatri} className="rounded-full cartImageRes" />
            </div>
          </div>
        </div>   
